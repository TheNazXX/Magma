...
(function BuildCanvasImages(){
  ...
  const canvasPaperImages = document.querySelector("#page7>canvas");
  const triggerCanvasPaperImages = "#page7";
  ...
  createCanvasImages(canvasPaperImages, papersImages, triggerCanvasPaperImages);
...
(function TransformTextColor(){
  ...
  const textPage6 = document.querySelector('#page6>h1');

  textColorTransform(textPage2);
  textColorTransform(textPage4);
  textColorTransform(textPage6);
})();
...
function textColorTransform(textPage){
  ...
  gsap.to(textPage.querySelectorAll("span"), {
    scrollTrigger:{
        trigger: textPage.querySelectorAll("span"),
        start:`top bottom`,
        end:`bottom top`,
        scroller:`#main`,
        scrub:.5,
